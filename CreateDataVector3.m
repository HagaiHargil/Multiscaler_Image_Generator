%% Script info
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% File name: "CreateDataVector3.m"                            %
% Purpose: Reads the hex_data vector that was created          %
% by LSTDataRead.m and creates a photon table of that          %
% measurement. Only reads the time_patch == 3 data.           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%

function [Final_Dataset] = CreateDataVector3(Raw_Data, Data_Channel_Num, Range)
%% Check input
...
switch Data_Channel_Num
    case 1
        ...
        TAG_Bits = Data_Readings(:,2:6); % reads TAG bits data and converts it to decimal
        Time_of_Arrival = bin2dec(Data_Readings(:,7:60)); % reads timestamp data and converts it to decimal
    case 2
